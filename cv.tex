...
\begin{description}
\item[\textnormal{2021}] Yuki Kang (Biostat), Xuemin Zhu (Biostat), Luchao Qi (BME)
\item[\textnormal{2020}] Luchao Qi (Biostat)
...
\begin{description}
\item[\textnormal{2021}] Eric Bridgeford (Biostat),  Olivia Leavitt (BME), Alessandro Orlando, Sri Sankar (BME)
\item[\textnormal{2020}] Huan Chen (Biostat), Sayan Ghosal (EE, GBO),  Hamed Honari (EE, GBO), Bohao Tang (Biostat), Vy Tran (EHE), Guoqing Wang (Biostat), Jennine Wellner (GTPCI)
...
\begin{description}
\item[\textnormal{2021}] Bingkai Wang (Biostat)
