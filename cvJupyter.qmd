...
"""
## For right now, comment this out, since I can't seem to install
## wordcloud. using old version
import stylecloud as sc
...
"""
## once again commenting this out until I can figure it out
...
plt.xticks([]);
plt.yticks([]);
plt.imshow(img1, frameon = False);

plt.subplot(1, 2, 2);
plt.xticks([]);
plt.yticks([]);
plt.imshow(img2, frameon = False);
```
